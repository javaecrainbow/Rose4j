...
function setmain(title,href){
	...
	return false;		
 		...
 		$(function(){
 			...
 			$("#selectSkin").val(userSkin);
 			$.cookie("hsSkin",userSkin, { path: '/', expires: 10 });
 	...
 	$("#btnEp").bind("click",function(){
 		if($('#personalForm').form('validate')){
 			$.post("<%=basepath%>/userinfo/changeProfile",$("#personalForm").serializeArray(),function(data){
 			}).success(function(){window.location.reload();}).error(function(){window.location.reload();});
 		}
 	});
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 50px;
        ...
        <span style="float:right; padding-right:20px;" class="head">${userinfo.userName} 你好！&nbsp;&nbsp;<a href="#" id="editpass">修改个人信息</a>
         ...
         <a href="<%=basepath%>/userinfo/logonout" id="loginOut">安全退出</a>
          <a href="#" id="">帮助</a></span>
         </span>
      
          
        <span style="padding-left:10px; font-size: 16px; "><img src="../images/sys/lab2.jpg" width="50" height="50" align="absmiddle" /> 银行客户管理系统</span>

    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="panel-header">Copy Right: 2014 &nbsp;&nbsp;&nbsp;</div>
    </div>
	...
	<div data-options="region:'south',border:false" style="height:50px;background:#A9FACD;padding:10px;">south region</div>
        ...
        <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
				<div title="关于"  data-options="href:'<%=basepath %>/screen/_content.html'" style="padding:10px">
				</div>
