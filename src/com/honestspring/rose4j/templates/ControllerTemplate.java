...
public class ControllerTemplate
{
  ...
  protected final String TEXT_6 = ";" + NL + "import java.util.HashMap;" + NL + "import java.util.List;" + NL + "import java.util.Map;" + NL + "" + NL + "import javax.servlet.http.HttpServletRequest;" + NL + "" + NL + "import org.springframework.beans.factory.annotation.Autowired;" + NL + "import org.springframework.stereotype.Controller;" + NL + "import org.springframework.ui.Model;  " + NL + "import org.springframework.web.bind.annotation.RequestMapping;" + NL + "import org.springframework.web.bind.annotation.RequestMethod;" + NL + "import org.springframework.web.bind.annotation.PathVariable;" + NL + "import org.springframework.web.bind.annotation.RequestParam;" + NL + "import org.springframework.web.bind.annotation.ResponseBody;" + NL + "import com.honestspring.sys.util.DataGridModel;" + NL + "@Controller" + NL + "@RequestMapping(\"/";
  ...
  protected final String TEXT_18 = "/list\";" + NL + "\t}" + NL + "" + NL + "\t@RequestMapping(value = \"/popWindow/{option}\", method = RequestMethod.GET)" + NL + "\t\tpublic String popWindow(@PathVariable String option, Model model) throws Exception {" + NL + "\t\tmodel.addAttribute(\"option\", option);" + NL + "\t\treturn \"";
  protected final String TEXT_19 = "/";
  protected final String TEXT_20 = "/input\";" + NL + "\t}" + NL + "\t@RequestMapping(value = \"/addOrUpdate/{option}\", method = RequestMethod.POST)" + NL + "\t@ResponseBody" + NL + "\tpublic Map<String, String> addOrUpdate( ";
  protected final String TEXT_21 = " ";
  protected final String TEXT_22 = ",HttpServletRequest request,@PathVariable String option) throws Exception {" + NL + "\t\t// spring会利用jackson自动将返回值封装成JSON对象，比struts2方便了很多" + NL + "\t\tMap<String, String> map = new HashMap<String, String>();" + NL + "\t\ttry {" + NL + "\t\t\t";
